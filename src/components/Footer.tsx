...
const Footer = () => {
  ...
  return (
    <footer className="bg-frosi-navy border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-frosi-purple transition-colors">
                Discord
              </a>
              <a href="#" className="text-gray-400 hover:text-frosi-purple transition-colors">
                TikTok
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {tools.map((tool, index) => (
                ...
                >
                  <tool.icon className="w-4 h-4 group-hover:text-frosi-purple transition-colors" />
                  <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <input 
                ...
                className="flex-1 bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-frosi-purple"
              />
              <button className="bg-gradient-frosi hover:bg-gradient-frosi-hover text-white px-4 py-2 rounded-lg transition-all">
                Zapisz się
              </button>
            </div>
          </div>
